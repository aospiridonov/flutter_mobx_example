...
Map<String, dynamic> _$TodoListToJson(TodoList instance) => <String, dynamic>{
      'todos': const TodoListConvertor().toJson(instance.todos),
...
mixin _$TodoList on _TodoList, Store {
  ...
  ObservableList<Todo> get completedTodos => (_$completedTodosComputed ??=
      ...
      .value;
  Computed<bool>? _$hasComputedTodosComputed;

  @override
  bool get hasComputedTodos => (_$hasComputedTodosComputed ??= Computed<bool>(
          () => super.hasComputedTodos,
          name: '_TodoList.hasComputedTodos'))
      .value;
...
hasComputedTodos: ${hasComputedTodos},
